...
class Settings:
    def __init__(self) -> None:
        ...
        # gpt-4o-mini reliably parses/ranks, but degenerates (runaway output) on the
        # nested refinement schema, so the refine step uses a stronger model.
        self.refine_model: str = os.getenv("OPENAI_REFINE_MODEL", "gpt-4o")
